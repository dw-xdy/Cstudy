...
//    for (i = 0; i < n; i++) {
//        sum += term;
//        term = term * 10 + a;  // 例如：2变成22，22变成222，以此类推
//    }
//
//    printf("计算结果为：%d\n", sum);
//
...
//int main()
//{
//	long long a = -2147483648; //这个用“位运算”中的“取反”是无法进行运算的!, 原因是因为无法在计算机中进行转化!
//	long long ret = xf(a);     //改成“long long”类型的也不行,因为取反进行运算的程序是无法用这个表示的!
//	printf("%lld", ret);
//	return 0;
//}
